...
class StateDAO():
    def get_state_based_on_country(self, country_name):
        states = StateVO.query.filter_by(
...
class CityDAO():
    def get_citie_based_on_state(self, state_name):
        cities = CityVO.query.filter_by(state_name=state_name).all()
